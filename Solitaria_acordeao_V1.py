...
while continua == True:
    ...
    if movimentos == []:
        ...
        print ("Para empilhar sobre {}, digite 1, e para {}, digite 2".format(baralho [carta - 1], baralho[carta - 3]))
    ...
    possui_movimentos_possiveis(baralho)

if continua == True and baralho == []
    print("Parabéns, você ganhou!!!")
else:
    print("Você perdeu, que pena! Para tentar novamente, reinicie o código com o arquivo")
